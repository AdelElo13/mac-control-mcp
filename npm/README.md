...
Native Swift MCP server for full macOS automation — 153 tools in one Developer ID signed, notarized `.app`. No Python, no Electron, no Node runtime in the hot path.
