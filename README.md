...
1. Download [**mac-control-mcp-v0.2.1.mcpb**](https://github.com/AdelElo13/mac-control-mcp/releases/download/v0.2.1/mac-control-mcp-v0.2.1.mcpb) from the release page.
...
1. Download [**MacControlMCP-v0.2.1-macos-universal.tar.gz**](https://github.com/AdelElo13/mac-control-mcp/releases/download/v0.2.1/MacControlMCP-v0.2.1-macos-universal.tar.gz).
...
```bash
shasum -a 256 MacControlMCP-v0.2.1-macos-universal.tar.gz
# should match MacControlMCP-v0.2.1-macos-universal.sha256 on the release
```
...
| MCP Registry | Published as `io.github.AdelElo13/mac-control-mcp` v0.2.1 — distributed as an `.mcpb` bundle for one-click install |
